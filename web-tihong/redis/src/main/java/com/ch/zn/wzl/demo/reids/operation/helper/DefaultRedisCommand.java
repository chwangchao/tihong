...
public class DefaultRedisCommand implements JedisCommands {

	private int defaultDb;

	private ProxyRedisCommand proxyRedisCommand;
	...
	public String set(String key, String value) {
		return proxyRedisCommand.set(defaultDb, key, value);
	}

	@Override
	public String set(String key, String value, String nxxx, String expx, long time) {
		return this.proxyRedisCommand.set(defaultDb, key, value, nxxx, expx, time);
	}
